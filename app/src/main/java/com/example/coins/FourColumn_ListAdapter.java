...
public class FourColumn_ListAdapter extends ArrayAdapter<Coin> {
    private LayoutInflater mInflater;
    private ArrayList<Coin> coins;
    private int mViewResourceId;

    public FourColumn_ListAdapter (Context context, int textViewResourceId, ArrayList<Coin> coins) {
